...
check_token() {
  ...
  if [ "$USER_TOKEN" = "neko" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Ke Yukako${NC}"
    echo -e "${YELLOW}TELEGRAM : @Yukakoo${NC}"
    echo -e "${YELLOW}WHATSAPP : 628-${NC}"
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/Yukako-Nko/Tools-Installer/raw/refs/heads/main/C2.zip")
        break
        ;;
      2)
        ...
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/Yukako-Nko/Tools-Installer/raw/refs/heads/main/C3.zip")
        break
        ;; 
      x)
        return
...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  bash <(curl https://raw.githubusercontent.com/Yukako-Nko/Tools-Installer/refs/heads/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer Yukakoo   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${WHITE}ggg:     gg.     -   ,ggg       • WhatsApp : 628-    ${NC}"
  echo -e "${WHITE} ggg:     ggg._    _,ggg        • Credit  : Yukakoo ${NC}"
  echo -e "${WHITE} ggg.    '.'''ggggggp           • Support by Yukakoo  ${NC}"
